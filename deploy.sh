...
VPS_DIR="/var/www/resume"       # Diretório onde o projeto será hospedado
LOCAL_BUILD_DIR="dist"          # Diretório de build do Vite
DOMAIN="vps.rodrigoalves.dev"   # Domínio configurado no Caddy

echo "🚀 Iniciando Deploy do Projeto Vite.js para $VPS_IP ..."
